...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=tamilan;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/tamilan_textile/';
    $fsitename = 'http://localhost/ttbilling/tamilan_textile/';
    ...
    $db = new PDO('mysql:host=localhost;dbname=tamilan;charset=utf8mb4', 'tamilan', 'tamilan');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "tamilan", "tamilan", "tamilan");
    $sitename = "https://ttbilling.in/tamilantextile/";
    $site = 'https://ttbilling.in/tamilantextile/';
    $fsitename = 'https://ttbilling.in/tamilantextile/';
