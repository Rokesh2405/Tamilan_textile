                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            ...
                            <input type="text"  required="required" name="contact_person" id="name" placeholder="Enter Contact Person Name" class="form-control" value="<?php echo stripslashes(getcustomer('contact_person',$_REQUEST['cid'])); ?>" />
                        </div>
                          <div class="col-md-4">
                            <label>Emailid</label>
...
<div class="col-md-4">
  ...
  <div class="col-md-4">
                            ...
                            <input type="text" name="credit_limit_amt" id="credit_limit_amt" placeholder="Enter Credit Limit Amount" class="form-control" value="<?php echo stripslashes(getcustomer('credit_limit_amt',$_REQUEST['cid'])); ?>" />
                        </div>
                          <div class="col-md-4">
                            <label>Credit Limit Days</label>
                            <input type="text" name="credit_limit_days" id="credit_limit_days" placeholder="Enter Credit Limit Days" class="form-control" value="<?php echo stripslashes(getcustomer('credit_limit_days',$_REQUEST['cid'])); ?>" />
                        </div>
   <div class="col-md-4">
                    ...
                    <!-- <div class="row">
                     ...
                     <div class="row">
                        ...
                        <!-- <div class="col-md-4">
                                ...
                                <input type="text" required="required" id="idproof"  name="idproof" placeholder="Enter The ID Proof" class="form-control" value="<?php echo stripslashes(getcustomer('idproof',$_REQUEST['cid'])); ?>" />
                        </div> -->
                        <!-- <div class="col-md-4">
